...
namespace Pizzas
{
    public class Ticket
    {
        ...
        int maxChar = 32;               //Esta determina el numero maximo de caracteres que puede haber en cada linea.
        int maxCharDescription = 17;    //Esta determina el numero maximo de caracteres que puede haber por cada descripcion de un articulo,esto es para que no se encime con el importe.
        ...
        public void SetEncabezadoColumna(string encabezadoColumna)
        {
            this.EncabezadoColumna=encabezadoColumna;
        ...
        {            
            ...
            pr.PrinterSettings.PrinterName = getImpresoraPorDefecto(); 
        ...
        private void DrawItems()
        {
            ...
            gfx.DrawString(EncabezadoColumna, printFont, myBrush, leftMargin, YPosition(), new StringFormat());
